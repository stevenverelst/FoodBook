...
<div class="container-fluid">
    <div class="card text-white card-body bg-success mt-2">
        ...
        <form action="<?php echo Util::getUrlRoot(); ?>/controllers/User" methode="post">
            <div class="row">
                <div class="col-sm-4 mx-auto">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control form-control-sm" value="<?php echo Register::getData('name'); ?>">
                        <span class="invalid-feedback" id="nameErr"></span>
                    </div>
                    <div class="form-group">
                        <label for="firstName">First name: <sup>*</sup></label>
                        <input type="text" name="firstName" id="firstName" class="form-control form-control-sm" value="<?php echo Register::getData('firstName'); ?>">
                        <span class="invalid-feedback" id="firstNameErr"></span>
                    </div>
                    <div class="form-group">
                        <label for="email">Email: <sup>*</sup></label>
                        <input type="email" name="email" id="email" class="form-control form-control-sm" value="<?php echo Register::getData('email'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="confirmPassword" id="confirmPassword" class="form-control form-control-sm" value="<?php echo Register::getData('confirmPassword'); ?>">
                    ...
                    <div class="row">
                        <div class="col-sm-12 mx-auto">
                            <div class=" form-group">
                                ...
                                <input type="text" name="street" id="street" class="form-control form-control-sm" value="<?php echo Register::getSubData(['address', 'street']); ?>">
                        ...
                        <div class="col-sm-6 mx-auto">
                            <div class=" form-group">
                                ...
                                <input type="text" name="houseNumber" id="houseNumber" class="form-control form-control-sm" value="<?php echo Register::getSubData(['address', 'number']); ?>">
                        ...
                        <div class="col-sm-6 mx-auto">
                            <div class=" form-group">
                                ...
                                <input type="text" name="box" id="box" class="form-control form-control-sm" value="<?php echo Register::getSubData(['address', 'box']); ?>">
                                <span class="invalid-feedback" id="houseNumberErr"></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4 mx-auto">
                            <div class="form-group">
                                ...
                                <input type="text" name="zipcode" id="zipcode" class=" form-control form-control-sm" value="<?php echo Register::getSubData(['address', 'zipcode']); ?>">
                        ...
                        <div class="col-sm-8 mx-auto">
                            <div class="form-group">
                                ...
                                <input type="text" name="city" id="city" class=" form-control form-control-sm" value="<?php echo Register::getSubData(['address', 'city']); ?>">
